...
class ImageHelper {
  ...
  static const String extPNGType = ".png";
  static const String extSVGType = ".svg";
  ...
  static String wrapAssets(String url, {String fileExtensions = extPNGType}) {
    return "assets/images/" + url + fileExtensions;
  }

  static String wrapAssetsIcon(String url, {bool need1x = false, String fileExtensions = extPNGType}) {
    return 'assets/images/icons/${need1x ? "/1.0x" : ""}' + url + fileExtensions;
  }

  static String wrapAssetsBG(String url, {String fileExtensions = extPNGType}) {
    return 'assets/images/backgrounds/' + url + fileExtensions;
  }

  static String wrapAssetsLogo(String url, {String fileExtensions = extPNGType}) {
    return 'assets/images/logos/' + url + fileExtensions;
  }

  static String wrapAssetsDefault(String url, {String fileExtensions = extPNGType}) {
    return 'assets/images/default/' + url + fileExtensions;
  }

  static String wrapAssetsBanner(String url, {String fileExtensions = extPNGType}) {
  ...
  static Widget placeHolderLocalImg({required String imageName, double? width, double? height}) {
    return SizedBox(
      width: width,
      height: height,
      child: Image.asset(wrapAssets(imageName), fit: BoxFit.fill),
    );
  }
  ...
  static Widget placeHolderLocalSVGImg({required String imageName, double? width, double? height}) {
    return SizedBox(
      width: width,
      height: height,
      child: SvgPicture.asset(wrapAssets(imageName, fileExtensions: extSVGType), fit: BoxFit.fill),
    );
  }
