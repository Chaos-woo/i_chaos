...
class TTBaseDialog extends StatefulWidget {
  ...
  TTBaseDialog({
    ...
    required this.isSystemBottomDialog,
    this.title,
    ...
    required this.notTitleContentFontSize,
    required this.contentAlign,
    required this.contentFontWeight,
    this.customWidgetButtons,
    this.buttons,
    required this.cancelButtonColor,
    required this.otherButtonColor,
    required this.cancelButtonFontSize,
    required this.otherButtonFontSize,
    required this.cancelButtonFontWeight,
    required this.otherButtonFontWeight,
