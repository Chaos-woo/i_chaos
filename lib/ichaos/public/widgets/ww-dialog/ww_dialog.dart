...
import 'package:i_chaos/ichaos/public/widgets/ww-dialog/ww_middle_bottom_dialog_widget.dart';
import 'package:i_chaos/ichaos/public/widgets/ww-dialog/ww_top_dialog_widget.dart';
...
class WWDialog {
  // 中间弹窗
  static Future<T?> showMiddleDialog<T>(BuildContext context,{
  ...
  // 底部弹窗
  static Future<T?> showBottomDialog<T>(BuildContext context,{
    Color bgColor: Colors.white,
    bool isShowCloseButton: false,
    bool isNeedCloseDiaLog: true,
  ...
  // 顶部弹窗
  static Future<T?> showTopDialog<T>(BuildContext context,{
